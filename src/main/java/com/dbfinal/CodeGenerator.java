...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://120.27.193.57:3306/VOA?useUnicode=true&useSSL=false&characterEncoding=utf8";   //注意修改数据库名
        String name="root";
...
//        List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的后缀
        ...
        //基本信息
        String author = "Yingkai Hao";    //作者
        String parent = "com";   //父包名
        String module = "dbfinal";   //模块包名
